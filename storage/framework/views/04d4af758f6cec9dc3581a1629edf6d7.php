<?php $__env->startSection('title', 'Decision Forest - Where Code Meets Community | India\'s Premier Tech Community'); ?>
<?php $__env->startSection('meta_description', 'Decision Forest is India\'s fastest-growing coding community. Join 1500+ students building their future through hackathons, workshops, and placement support. Code. Connect. Conquer.'); ?>
    ...
    <div class="container">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="<?php echo e(route('community')); ?>" class="btn btn-primary">
                    Join 1500+ Developers
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M5 12h14M12 5l7 7-7 7"/>
                    </svg>
                </a>
                <a href="<?php echo e(route('events')); ?>" class="btn btn-secondary">
                    Explore Events
                </a>
            </div>
        </div>
    ...
    <div class="container">
        <div class="about-preview">
            ...
            <div class="about-content">
                ...
                <a href="<?php echo e(route('about')); ?>" class="btn btn-primary">Learn Our Story</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="events-grid">
            <div class="event-card">
                ...
                <div class="event-content">
                    ...
                    <a href="<?php echo e(route('events')); ?>" class="btn btn-outline">Learn More</a>
                </div>
            </div>
            <div class="event-card">
                ...
                <div class="event-content">
                    ...
                    <a href="<?php echo e(route('community')); ?>" class="btn btn-outline">Join Waitlist</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/varun/Desktop/decisionforest/resources/views/pages/home.blade.php ENDPATH**/ ?>