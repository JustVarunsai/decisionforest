...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title><?php echo $__env->yieldContent('title', 'Decision Forest - Empowering Future Tech Leaders'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Decision Forest is India\'s fastest-growing coding community. Join 1500+ students building their future through hackathons, workshops, and placement support.'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords', 'coding community, hackathons, tech community India, placement support, CSE students, programming, software development, Decision Forest'); ?>">
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('og_title', 'Decision Forest - Empowering Future Tech Leaders'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('og_description', 'Join India\'s fastest-growing coding community. 1500+ members, hackathons, workshops, and placement support.'); ?>">
    ...
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('twitter_title', 'Decision Forest - Empowering Future Tech Leaders'); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('twitter_description', 'Join India\'s fastest-growing coding community.'); ?>">
    ...
    <nav class="navbar" id="navbar">
        <div class="container">
            ...
            <ul class="nav-links" id="navLinks">
                ...
                <li><a href="<?php echo e(route('events')); ?>" class="<?php echo e(request()->routeIs('events') ? 'active' : ''); ?>">Events</a></li>
                <li><a href="<?php echo e(route('community')); ?>" class="<?php echo e(request()->routeIs('community') ? 'active' : ''); ?>">Community</a></li>
                <li><a href="<?php echo e(route('contact')); ?>" class="<?php echo e(request()->routeIs('contact') ? 'active' : ''); ?>">Contact</a></li>
                <li><a href="<?php echo e(route('community')); ?>" class="nav-cta">Join Now</a></li>
            </ul>
        ...
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-links">
                    <h4>Resources</h4>
                    <ul>
                        <li><a href="<?php echo e(route('events')); ?>">Hackathons</a></li>
                        <li><a href="<?php echo e(route('community')); ?>">Join Community</a></li>
                        <li><a href="<?php echo e(route('contact')); ?>">Contact Us</a></li>
                        <li><a href="<?php echo e(route('contact')); ?>">Partner With Us</a></li>
                    </ul>
                </div>
            ...
            <div class="footer-bottom">
                <p>&copy; <?php echo e(date('Y')); ?> Decision Forest. All rights reserved.</p>
...
<?php /**PATH /Users/varun/Desktop/decisionforest/resources/views/layouts/app.blade.php ENDPATH**/ ?>